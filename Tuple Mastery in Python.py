...
def format_flight_itineries(itineraries):
    counter = 0 
    for name, take_off, landing in itineraries:
        counter +=1
        print(f"Itinerary {counter}: Traveler: {name} - From {take_off} to {landing} ")

itinerary = ("Alice", "New York", "London"), ("Bob", "Tokyo", "San Francisco"), ("Kyle","Dallas", "Kansas city")



format_flight_itineries(itinerary)
